...
class TermiiService {
  constructor() {
    ...
    if (!this.apiKey) {
      console.warn(
        "TermiiService: TERMII_API_KEY not found in environment variables"
      );
    }
  }
  ...
  async sendSMS(phoneNumber, message) {
    ...
    try {
      ...
      console.log(
        "TermiiService: SMS sent successfully, response:",
        response.data
      );
      return {
        success: true,
      ...
      console.error(
        "TermiiService: Error sending SMS:",
